...
const ProtectionCivileQuizGame = () => {
  ...
  // Base de données des questions organisées par catégorie
  const questionCategories = {
    'ثقافة عامة': {
      ...
      questions: [
        {
          question: 'ما هو رقم الطوارئ للحماية المدنية في تونس؟',
          options: ['198', '199', '197', '911'],
          correct: 0,
          explanation: 'رقم 198 هو الرقم المخصص للاتصال بالحماية المدنية في تونس'
        },
        {
          question: 'متى تأسست النواة الأولى للحماية المدنية في تونس؟',
          options: ['1894', '1920', '1949', '1993'],
          correct: 0,
          explanation: 'تأسست في 1 نوفمبر 1894 تحت اسم جمعية التعاون للنجدة'
        },
        {
          question: 'ما هو شعار الحماية المدنية؟',
          options: ['وقاية نجدة إنقاذ', 'حماية وأمان', 'خدمة ووطنية', 'أمن وسلامة'],
          correct: 0,
          explanation: 'الشعار الرسمي هو: وقاية نجدة إنقاذ'
        },
        {
          question: 'كم عدد أفراد الحماية المدنية حاليا؟',
          options: ['5000', '6000', '7054', '8000'],
          correct: 2,
          explanation: 'العدد الحالي هو 7054 شخص'
        }
      ]
    },
    'مهام ومشمولات': {
      ...
      questions: [
        {
          question: 'من المهام الأساسية لعون الحماية المدنية:',
          options: ['حماية الأرواح والممتلكات', 'جمع الضرائب', 'التعليم', 'الزراعة'],
          correct: 0,
          explanation: 'حماية الأرواح والممتلكات هي المهمة الأساسية'
        },
        {
          question: 'متى يتدخل عون الحماية المدنية؟',
          options: ['في أوقات محددة فقط', 'في كل الأوقات والأماكن', 'في النهار فقط', 'عند الطلب المسبق'],
          correct: 1,
          explanation: 'عون الحماية المدنية مطالب بالتدخل في كل الأوقات والأماكن'
        },
        {
          question: 'أي من هذه ليس من مهام الحماية المدنية؟',
          options: ['إطفاء الحرائق', 'الإسعاف الطبي', 'حفظ الأمن العام', 'إنقاذ الغرقى'],
          correct: 2,
          explanation: 'حفظ الأمن العام من مهام الأمن الداخلي وليس الحماية المدنية'
        }
      ]
    },
    'رتب عسكرية': {
      ...
      questions: [
        {
          question: 'ما هي أعلى رتبة في الحماية المدنية؟',
          options: ['عقيد', 'عميد', 'مقدم', 'رائد'],
          correct: 1,
          explanation: 'العميد هو أعلى رتبة في الحماية المدنية'
        },
        {
          question: 'أي من هذه الرتب تأتي قبل النقيب؟',
          options: ['مالزم', 'رائد', 'مقدم', 'عقيد'],
          correct: 0,
          explanation: 'المالزم يأتي قبل النقيب في التسلسل الهرمي'
        },
        {
          question: 'من صنف الرقباء والأعوان:',
          options: ['نقيب', 'وكيل', 'مالزم', 'رائد'],
          correct: 1,
          explanation: 'الوكيل من صنف الرقباء والأعوان وليس من الضباط'
        }
      ]
    },
    'حقوق وواجبات': {
      ...
      questions: [
        {
          ...
          correct: 1,
          explanation: 'حريق لندن العظيم سنة 1666 كان من الحرائق المسجلة في التاريخ'
        },
        {
          question: 'متى تم إحداث الديوان الوطني للحماية المدنية؟',
          options: ['1993', '1991', '1975', '1980'],
          correct: 0,
          explanation: 'صدر القانون عدد 121 لسنة 1993 لإحداث الديوان الوطني'
        },
        {
          question: 'من أسس المنظمة الدولية للحماية المدنية؟',
          options: ['هنري دونان', 'جورج سان بول', 'نابليون', 'شارل ديغول'],
          correct: 1,
          explanation: 'الطبيب الفرنسي جورج سان بول أسسها سنة 1931'
        }
      ]
    },
    'التطوع': {
      ...
      questions: [
        {
          question: 'ما المقصود بالتطوع في الحماية المدنية؟',
          options: ['عمل مقابل أجر', 'عمل تلقائي بدون مقابل', 'عمل جزئي', 'عمل موسمي'],
          correct: 1,
          explanation: 'التطوع هو القيام تلقائيا وبدون مقابل بعمل إنساني (الفصل الأول)'
        },
        {
          question: 'كيف يتم استدعاء المتطوعين؟',
          options: ['بالهاتف فقط', 'بصفارة الإنذار فقط', 'بالهاتف أو صفارة إنذار', 'بالبريد'],
          correct: 2,
          explanation: 'الاستدعاء يكون بالاتصال المباشر أو صفارة إنذار خاصة (الفصل 10)'
        },
        {
          question: 'متى يمكن شطب المتطوع؟',
          options: ['عند المرض', 'عند السفر', 'عند ارتكاب مخالفة', 'عند تغيير العنوان'],
          correct: 2,
          explanation: 'يمكن الشطب عند ارتكاب مخالفة تمس بسير العمل (الفصل 9)'
        }
      ]
    }
  };
