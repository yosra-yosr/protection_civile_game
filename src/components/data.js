  ...
  questions: [
    ...
    'رتب عسكرية': {
      ...
      questions: [
        ...
        { question: 'أي من هذه الرتب تأتي قبل الرتبة التي بالصورة؟',image: '/images/na9ib.png', options: [' ملازم أول', 'رائد', 'مقدم', 'عقيد'], correct: 0, explanation: 'المالزم يأتي قبل النقيب في التسلسل الهرمي' },
