...
export   const questionCategories = {
  ...
  explanation: 'شعار الحماية المدنية التونسية يحمل رموزاً مهمة تعكس مهام ورسالة هذا الجهاز الحيوي في خدمة المواطنين وحمايتهم من المخاطر المختلفة'
    ...
    {
      type: 'fill-in-blanks',
      paragraph: 'حسب الأمر عدد 2428، الحد الأدنى لسن التطوع في الحماية المدنية هو _____ سنة. يجب على المترشح التمتع بـ _____ وحسن السيرة، بالإضافة إلى اللياقة البدنية والانخراط في _____ المشار إليها بالفصل _____ من هذا الأمر.',
      blanks: [
